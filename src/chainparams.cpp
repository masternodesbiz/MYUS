...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04a7059e2e7d66e1b4f0216208206342086c6ae339a634b8322ef2584a5789d5fad5142a4f2e2c8fc79afc91cbdae39c3aa4da0a4c550458d258e917e08bcdedbe") << OP_CHECKSIG;
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0x00000120b8b5824730fce33281b0f369dd5107a8fd2e377bbe0ce38264bc5bfb"))
    (1, uint256S("0x00000617828af1ccd2d4c229d7e7e46c3b6d2f88469022cdcaaedfeee8159879"))
    (16, uint256S("0x00000aed1636b48720661824aa909b1e7733102660e6d3b502c1ad95059c43c6"))
    (100, uint256S("0x000000bfb480276ab865d61fc8b60eee63c69f2032b2233aa6314925dff550f3"))
    (101, uint256S("0x0000022b47951a72248e027f2533fda29d19682e1a233252cdce353d56415435"))
    ...
    (51874, uint256S("0xca037c68f5be1f4e3c464fefdaf92ad67cc2bbb816d21c3034dcd2053c5f06ce"))
    (56679, uint256S("0x1af154d39a0294475f78c197464feac18cba331264ac1e188eea076e08d40675"))
    (66125, uint256S("0xbd3d15f4d5b72639e1d3824df3af6d051e378d7d86e560149d5cee197c89b4a5"))
    (100000, uint256S("0xa925e5111e066ea438db11ce3c26401d10faeac8e3ec1c4c7dc841ab2f98483e"))
    (138290, uint256S("0xd1c6c7890cdb491ad7a24531a2d7cfdca4fadb69979bc88617562b8936df5301"))
    (152920, uint256S("0xf72bb5db7137756b8e15fbca5307ee422498fa132371afc26d716089f1d7f5af"))
    (152921, uint256S("0x09d2a39f79f7b7d775753ca5ee58d93cd65778e14d372be00cfcbecbd973ece9"))
    (200000, uint256S("0xe07d6ce561845b05c5ae429b45d1330b71049dfc9034ad3d4e4f50da005a8dd2"))
    (201560, uint256S("0xf1aba28d0584449c0d9648537dc30f222a604335ccfd7f71b62f82f8ff8a298a"));


static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1688908965, // * UNIX timestamp of last checkpoint block
    405933,          // * total number of transactions between genesis and last checkpoint
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of
    (0, uint256S("0x00000f1258cf5fe66784ce87f944abe6076fc7d37b3d24dd1a9a0fff1b63403e"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256S("0x00000b51846a7226be0e4bf34e2b2eb307bbb6e0285644250b656cf53988b05e"));
...
public:
    CMainParams()
    {
        ...
        strNetworkID = "main";
        genesis = CreateGenesisBlock(1676505555, 1851123, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000120b8b5824730fce33281b0f369dd5107a8fd2e377bbe0ce38264bc5bfb"));
        assert(genesis.hashMerkleRoot == uint256S("0x10b40459f01e82f4a61a6529c9370dc10b8df12913b33fe58d8c343006e31901"));
        ...
        // spork keys
        consensus.strSporkPubKey = "02dd239949adaf67d4af2c53e60c08c2e480dc67ad8995200c255ff21251c88690";
     ...
     //       { "XXXXXX", 0 },
        ...
        vSeeds.push_back(CDNSSeedData("seed01", "seed02.myus-coin.com"));
        vSeeds.push_back(CDNSSeedData("seed01", "seed03.myus-coin.com"));
        vSeeds.push_back(CDNSSeedData("seed01", "seed04.myus-coin.com"));
        vSeeds.push_back(CDNSSeedData("seed01", "seed05.myus-coin.com"));
...
public:
    CTestNetParams()
    {
        ...
        strNetworkID = "test";
        genesis = CreateGenesisBlock(1676505556, 474372, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f1258cf5fe66784ce87f944abe6076fc7d37b3d24dd1a9a0fff1b63403e"));
        assert(genesis.hashMerkleRoot == uint256S("0x10b40459f01e82f4a61a6529c9370dc10b8df12913b33fe58d8c343006e31901"));
        ...
        // spork keys
        consensus.strSporkPubKey = "039de1a2321ccb971b2dabdc59eab367f612558b0f795afc7812f1541c5c910df2";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;
...
public:
    CRegTestParams()
    {
        ...
        genesis = CreateGenesisBlock(1676505557, 632787, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000b51846a7226be0e4bf34e2b2eb307bbb6e0285644250b656cf53988b05e"));
        assert(genesis.hashMerkleRoot == uint256S("0x10b40459f01e82f4a61a6529c9370dc10b8df12913b33fe58d8c343006e31901"));
        ...
        consensus.strSporkPubKey = "035c25a849f89da953a598f5631247f4e456842b96baf6f67e9d02b5580ffe1ba6";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;
