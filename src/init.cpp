...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2022-%i Modden Developers & TylerAnderson T.A"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2023-%i The MultiSys Coin Developers & TylerAnderson T.A"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
